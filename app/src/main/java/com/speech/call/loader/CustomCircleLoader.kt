...
package com.speech.call.loader
...
import com.speech.call.R

class CustomCircleLoader : LinearLayout, LoaderContract {
    ...
    override fun initAttributes(attrs: AttributeSet) {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.CustomCircleLoader, 0, 0)

        this.dotsRadius = typedArray.getDimensionPixelSize(R.styleable.CustomCircleLoader_circle_dotsRadius, 50)

        this.distanceMultiplier = typedArray.getInteger(R.styleable.CustomCircleLoader_circle_distanceMultiplier, 4)

        this.firsDotColor = typedArray.getColor(R.styleable.CustomCircleLoader_circle_firstDotsColor,
                resources.getColor(R.color.loader_selected))

        this.secondDotColor = typedArray.getColor(R.styleable.CustomCircleLoader_circle_secondDotsColor,
                resources.getColor(R.color.loader_selected))

        this.thirdDotColor = typedArray.getColor(R.styleable.CustomCircleLoader_circle_thirdDotsColor,
                resources.getColor(R.color.loader_selected))

        this.drawOnlyStroke = typedArray.getBoolean(R.styleable.CustomCircleLoader_circle_drawOnlyStroke, false)

        if (drawOnlyStroke) {
            this.strokeWidth = typedArray.getDimensionPixelSize(R.styleable.CustomCircleLoader_circle_strokeWidth, 20)
        }

        this.animDuration = typedArray.getInt(R.styleable.CustomCircleLoader_circle_animDuration, 500)
